...
public class CollegeNoticesAdapter extends RecyclerView.Adapter<CollegeNoticesAdapter.NoticeViewHolder> {

    private ArrayList<JSONObject> noticeList;

    public CollegeNoticesAdapter(ArrayList<JSONObject> noticeList) {
    ...
    public void onBindViewHolder(@NonNull NoticeViewHolder holder, int position) {
        ...
        try {
            ...
            e.printStackTrace();
            holder.noticeTitle.setText("Error");
            holder.noticeContent.setText("Error");
            holder.noticeDate.setText("Error");
        }
    }
