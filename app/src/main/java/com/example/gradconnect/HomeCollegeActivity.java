...
public class HomeCollegeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setNavigationItemSelectedListener(item -> {
            ...
            if (id == R.id.notifications) {
                startActivity(new Intent(HomeCollegeActivity.this, CollegeCreateNotificationsActivity.class));
                drawerLayout.closeDrawer(GravityCompat.START); // Close drawer after selection
                return true;
            } else if (id == R.id.student_details) {
                startActivity(new Intent(HomeCollegeActivity.this, StudentDetailsActivity.class));
                drawerLayout.closeDrawer(GravityCompat.START); // Close drawer after selection
                return true;
            } else if (id == R.id.logout) {
                startActivity(new Intent(HomeCollegeActivity.this, LoginActivity.class));
                drawerLayout.closeDrawer(GravityCompat.START); // Close drawer after selection
                return true;
            }
    ...
    // Optional: Methods to open/close drawer programmatically
    ...
    private class ScreenSlidePagerAdapter extends FragmentStateAdapter {
        ...
        public Fragment createFragment(int position) {
            ...
            switch (position) {
                case 0:
                    fragment = new CollegeHome();
                    Log.d("LoginActivity", "Sending mobile_number: " + mobileNumber);
                    break;
                case 1:
                    fragment = new CreateNoticeCollege();
                    Log.d("LoginActivity", "Sending mobile_number: " + mobileNumber);
                    break;
                case 2:
                    fragment = new CollegeCreateEvents();
                    Log.d("LoginActivity", "Sending mobile_number: " + mobileNumber);
                    break;
                case 3:
                    fragment = new CollegeProfile();
                    Log.d("LoginActivity", "Sending mobile_number: " + mobileNumber);
                    break;
                default:
                    fragment = new CollegeHome();
