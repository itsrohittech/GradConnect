...
public class StudentDetailsCollegeActivity extends AppCompatActivity {

    private static final String TAG = "StudentDetailsCollegeActivity";
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                if (!mobileNumber.isEmpty()) {
                    ...
                    Toast.makeText(StudentDetailsCollegeActivity.this, "Please enter a mobile number", Toast.LENGTH_SHORT).show();
                }
                ...
                response -> {
                    try {
                        ...
                        if (response.has("data")) {
                            ...
                            Toast.makeText(StudentDetailsCollegeActivity.this, "No data found", Toast.LENGTH_SHORT).show();
                        }

                    } catch (JSONException e) {
                        e.printStackTrace();
                        Log.e(TAG, "Error parsing JSON: " + e.getMessage());
                        Toast.makeText(StudentDetailsCollegeActivity.this, "Error parsing JSON", Toast.LENGTH_SHORT).show();
                    }
                }, error -> {
            // Handle error
            Log.e(TAG, "Volley Error: " + error.getMessage());
            Toast.makeText(StudentDetailsCollegeActivity.this, "Error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
        });
