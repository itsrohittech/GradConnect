...
public class CollegeCreateNotificationsActivity extends AppCompatActivity {

    private static final String TAG = "CollegeCreateNotificationsActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.college_create_notifications);
