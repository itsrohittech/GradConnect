...
public class CreateNotice extends Fragment {
    ...
    private static final String TAG = "CreateNotice";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new AdminNoticeAdapter(noticeList);
                    ...
                    try {
                        ...
                        if (response.length() > 0) {
                            for (int i = 0; i < response.length(); i++) {
                                ...
                                // Parse JSON into a Notice object
                                Notice notice = new Notice(
                                        noticeObject.getString("notice_title"),
                                        noticeObject.getString("notice_content"),
                                        noticeObject.getString("notice_date")
                                );
