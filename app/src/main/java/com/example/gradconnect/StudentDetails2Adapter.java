...
public class StudentDetails2Adapter extends RecyclerView.Adapter<StudentDetails2Adapter.StudentDetails2ViewHolder> {

    private ArrayList<StudentDetails> studentDetailsList;

    public StudentDetails2Adapter(ArrayList<StudentDetails> studentDetailsList) {
        this.studentDetailsList = studentDetailsList;
    }

    @NonNull
    @Override
    public StudentDetails2ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new StudentDetails2ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull StudentDetails2ViewHolder holder, int position) {
    ...
    public static class StudentDetails2ViewHolder extends RecyclerView.ViewHolder {
        ...
        public StudentDetails2ViewHolder(@NonNull View itemView) {
            super(itemView);
